...
$Conf{RsyncSshArgs} = [
  '-e',
  '$sshPath -c aes256-gcm@openssh.com -o ServerAliveInterval=300 -x -l backuppc'
];
...
#
$Conf{CgiURL} = 'http://espressobin.local/cgi-bin/BackupPC/BackupPC_Admin';
